...
static ARG_TABLE option[] = {
    ...
    {"auth", STRING, TRUE, (void *)&AuthURL, N_("authentication server")},
    {"api", BOOLEAN, TRUE, (void *)&fAPI, N_("Use API")},
    {"debug", BOOLEAN, FALSE, (void *)&fDebug, N_("enable debug")},
#ifdef USE_SSL
    {"key", STRING, TRUE, (void *)&KeyFile, N_("SSL Key File(pem/p12)")},
    {"cert", STRING, TRUE, (void *)&CertFile, N_("Certificate(pem/p12)")},
    {"ssl", BOOLEAN, TRUE, (void *)&fSsl, N_("Use SSL")},
    {"verifypeer", BOOLEAN, TRUE, (void *)&fVerifyPeer,
     N_("Use Client Certification")},
    {"CApath", STRING, TRUE, (void *)&CA_Path, N_("CA Certificate Path")},
    {"CAfile", STRING, TRUE, (void *)&CA_File, N_("CA Certificate File")},
    {"ciphers", STRING, TRUE, (void *)&Ciphers, N_("SSL Cipher suite")},
#endif
