...
init()
{
    ...
    rb_define_method(cArrayValue, "_length", aryval_length, 0);
    rb_define_method(cArrayValue, "_size", aryval_length, 0);
    ...
    rb_define_method(cRecordValue, "_length", recval_length, 0);
    rb_define_method(cRecordValue, "_size", recval_length, 0);
    ...
    rb_define_method(cRecordStruct, "_name", rec_name, 0);
    rb_define_method(cRecordStruct, "_length", rec_length, 0);
    rb_define_method(cRecordStruct, "_size", rec_length, 0);
    ...
    rb_define_method(cPath, "_name", path_name, 0);
    rb_define_method(cPath, "_length", path_length, 0);
    rb_define_method(cPath, "_size", path_length, 0);
    ...
    rb_define_method(cTable, "_name", rec_name, 0);
    rb_define_method(cTable, "_length", rec_length, 0);
    rb_define_method(cTable, "_size", rec_length, 0);
