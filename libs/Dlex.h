...
#define T_BINDAPI (T_YYBASE + 6)
/*	LD only	*/
#define T_DATA (T_YYBASE + 7)
#define T_SPA (T_YYBASE + 8)
#define T_WINDOW (T_YYBASE + 9)
#define T_PORT (T_YYBASE + 10)
#define T_HOST (T_YYBASE + 11)
#define T_LINKAGE (T_YYBASE + 12)
#define T_MGROUP (T_YYBASE + 13)
#define T_HOME (T_YYBASE + 14)
