...
static	GOptionEntry entries[] = 
{
	{	"type",			't',	0,	G_OPTION_ARG_STRING, 
		&Type, "type <report> or <misc>", "T" },
	{	"printer",		'p',	0,	G_OPTION_ARG_STRING, 
		&Printer, "printer P", "P" },
	{	"title",		'T',	0,	G_OPTION_ARG_STRING, 
		&Title, "report title for report", "T" },
	{	"showdialog",	's',	0,	G_OPTION_ARG_NONE, 
		&ShowDialog, "show dialog", NULL },
	{	"filename",		'f',	0,	G_OPTION_ARG_STRING, 
		&Filename, "filename", "F" },
	{	"description",	'd',	0,	G_OPTION_ARG_STRING, 
		&Desc, "description for file", "D" },
	{	"port",		'P',	0,	G_OPTION_ARG_STRING, 
		&SysDataPort, "SystemDataThread port", "P" },
	{	NULL	}
};
