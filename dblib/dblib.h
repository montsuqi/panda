...
extern	ValueStruct	*ExecDBESCAPEBYTEA(DBG_Struct *dbg, DBCOMM_CTRL *ctrl, RecordStruct *rec, ValueStruct *args);
extern	ValueStruct	*ExecDBUNESCAPEBYTEA(DBG_Struct *dbg, DBCOMM_CTRL *ctrl, RecordStruct *rec, ValueStruct *args);
extern 	ValueStruct	*ExecDBQuery(DBG_Struct	*dbg, char *sql, Bool fRed, int usage);
