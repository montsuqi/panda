...
static ValueStruct *_PushEvent(DBG_Struct *dbg, DBCOMM_CTRL *ctrl,
...
extern DB_Func *InitPushEvent(void) {
  return (
      EnterDB_Function("PushEvent", Operations, DB_PARSER_NULL, &Core, "", ""));
}
