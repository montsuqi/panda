...
ENTER_FUNC;
	...
	DBSlave = NewDBSlaveThread(ThisDBG, LogDBG, DBMasterPort, DBMasterUser, DBMasterPassword, fNoSumCheck, ReplicationSec, ExpireLogSec);
	if (!DBSlave) {
...
*/
	{	"dbmport",		STRING,		TRUE,	(void*)&DBMasterPortNumber,
		"dbmaster port name"	 							},
	{	"dbmuser",			STRING,		TRUE,	(void*)&DBMasterUser,
		"dbmaster username"	 							},
	{	"dbmpass",			STRING,		TRUE,	(void*)&DBMasterPassword,
		"dbmaster password"	 							},
	{	"sec",	INTEGER,		TRUE,	(void*)&ReplicationSec,
		"replication interval sec"							},
	{	"expiresec",	INTEGER,		TRUE,	(void*)&ExpireLogSec,
		"expire log sec"								},

	{	"log",	STRING,		TRUE,	(void*)&LogDBGName,
		"log dbg name"									},
