...
char *GLP_GetStartupMessage(GLProtocol *);
...
GLProtocol *InitProtocol(const char *auth_uri, const char *user,
                         const char *pass);
#ifdef USE_SSL
void GLP_SetSSL(GLProtocol *, const char *cert, const char *key,
