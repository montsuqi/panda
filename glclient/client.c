...
extern void SetSessionBGColor(const char *bgcolor) {
  if (BGCOLOR(Session)) {
...
static void StopClient() { RPC_EndSession(GLP(Session)); }
...
static GOptionEntry entries[] = {{"list-config", 'l', 0, G_OPTION_ARG_NONE,
                                  &fListConfig, "show config list", NULL},
